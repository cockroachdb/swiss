...
// unsafeCtrlGroup reintreprets the given slice of ctrl values as a ctrlGroup.
// Note that some tests depend on the return value from this function using
// the same underlying memory as the supplied slice.
